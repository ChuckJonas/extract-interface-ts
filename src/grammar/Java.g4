...
@lexer::members {
  protected enumIsKeyword: boolean = true;
  protected assertIsKeyword: boolean = true;
}
...
ENUM:   'enum' {if (!this.enumIsKeyword) this._type = JavaLexer.Identifier;}
    ;

ASSERT
    :   'assert' {if (!this.assertIsKeyword) this._type = JavaLexer.Identifier;}
    ;
